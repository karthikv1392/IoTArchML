...
class Damped_Forecasts():
    ...
    def damped(self):
        ...
        for elem_list in test_set[last_index:]:
            ...
            fit1 = Holt(series,damped=True,exponential=True).fit(smoothing_level=0.8, smoothing_slope=0.2,damping_slope=0.1)
        ...
        pyplot.savefig("./plots/rmse_plot_damped_H30.png", dpi=300)


if __name__ == '__main__':
    ses_forecast_obj = Damped_Forecasts()
    ses_forecast_obj.damped()