...
public class Functions {
	...
	public static String myf(String [] args) {
		...
		String filename = "/Users/karthikvaidhyanathan/Dropbox/PyCharmProjects/IoTArchML/config.txt";
		try
		{
	...
	public static String adapter(String [] args) {
		...
		List<String> records = new ArrayList<String>();
		Map<String, Integer> configMap = new HashMap<String, Integer>();
		//String filename = "/Users/karthikvaidhyanathan/Documents/adaptation.txt";
		String filename = "C:\\Users\\karthik_vaidhyanatha\\adaptation.txt";
		try
		{
